jQuery(document).ready(function () {
  ...
  var grid = jQuery(".grid").imagesLoaded(function () {
    ...
    jQuery(".portfolio-text-holder").each(function () {
      jQuery(this)
        .find("p")
        .css("margin-top", jQuery(this).height() / 2);
    });
...
jQuery(window).load(function () {
  ...
  jQuery(".header-search").css(
    "margin-top",
    0 - jQuery(".header-search").innerHeight()
  );
  ...
  jQuery("#toggle, .header-hidden-search a").on(
    "click",
    multiClickFunctionStop
  );
...
var contactFormWidthFix = function () {
  ...
  ).innerWidth(jQuery(".wpcf7-form").width());
};
...
var multiClickFunctionStop = function (e) {
  ...
  if (jQuery("#toggle, .header-hidden-search a").hasClass("on")) {
    ...
    jQuery(".header-search")
      .removeClass("open")
      .animate(
        { marginTop: 0 - jQuery(".header-search").innerHeight() },
        function () {
          jQuery("#toggle, .header-hidden-search a").on(
            "click",
            multiClickFunctionStop
